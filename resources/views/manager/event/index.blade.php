                    ...
                    <div class="container mx-auto">
                        <div class="w-full mx-auto overflow-auto">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td class="px-4 py-3text-lg text-gray-900">{{ $event->name }}</td>
                        ...
                        <div class="flex px-4 py-3 w-full mx-auto">
                            <button onclick="location.href='{{ route('event.create') }}'" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">新規登録</button>
                        </div>
                    </div>
                </section>
                </div>
