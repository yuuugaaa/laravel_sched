                    ...
                    <div class="max-w-2xl mx-auto">
                        ...
                        <form method="POST" action="{{ route('event.store') }}">
                            ...
                            <div class="flex pt-3 w-full mx-auto">
                                <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" :value="old('information')">新規登録</button>
                            </div>
                        </form>
                    </div>
